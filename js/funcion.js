...
const busquedaClima = async function (busqueda) {
  try {
    ...
    if (icon_Nubes.includes("Clouds")) {
      icon.setAttribute("href", "./images/Icons.svg#icon-Nubes");
    }
    if (icon_Nubes.includes("Clear")) {
      icon.setAttribute("href", "./images/Icons.svg#icon-calor");
    }
    if (icon_Nubes.includes("Fog")) {
      icon.setAttribute("href", "./images/Icons.svg#icon-Icono1");
    }
    if (icon_Nubes.includes("Rain")) {
      icon.setAttribute("href", "./images/Icons.svg#icon-Icono1");
    }
    if (icon_Nubes.includes("Snow")) {
      icon.setAttribute("href", "./images/Icons.svg#icon-Icono3");
    }
